...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    gsap.set(images, { opacity: 0, position: "absolute", top: 0, left: 0 });
    ...
    const backgroundColors = ["#ffffff", "radial-gradient(50% 50% at 50% 50%, #4602D9 0%, #111111 100%)", "radial-gradient(50% 50% at 50% 50%, #FF3A44BF 0%, #111111 100%)"]; 
    ...
    <div className={styles.landingBody} style={{ height: "350vh" }}>
      ...
      >
        <div className={styles.holdingPhone}>
          <img className={styles.mainBackgroundImage} src={holdingPhone} alt="a hand holding a phone"/>
          ...
          <div>
            <div className={styles.screenImage}>
              <img
                ...
                src={screen1}
                alt="First Screen"
                className={styles.changingImages}
              />
              <img
  ...
  <img
    ...
    className={styles.changingImages}
  />
  {/* <img src={TestimonialCard} alt="Testimonial" className={styles.TestimonialCard} /> */}
</div>
              ...
              <div className={styles.navigationBtns}>
                <button
                  ...
                  className={`${styles.navigationBtnsButton} ${activeButtonIndex === 1.5 ? styles.activeButton : ""}`}
                >
                  Currency Converter
                  <span>&#8377;</span>
                </button>
                <button
                  ...
                  className={`${styles.navigationBtnsButton} ${activeButtonIndex === 2.5 ? styles.activeButton : ""}`}
                >
                  Live rates
                  <span>
                ...
                <button
                  ...
                  className={`${styles.navigationBtnsButton} ${activeButtonIndex === 3.5 ? styles.activeButton : ""}`}
                >
                  Set rate alert
                  <span>
                    <GoAlertFill />
